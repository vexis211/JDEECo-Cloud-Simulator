...
DROP TABLE IF EXISTS `simulation_configuration`;
...
CREATE TABLE IF NOT EXISTS `simulation_data` (
  ...
  `PathToPom` varchar(256) NOT NULL,
...
DROP TABLE IF EXISTS `simulation_execution`;
...
DROP TABLE IF EXISTS `visible_project`;
