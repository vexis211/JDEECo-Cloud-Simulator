...
public interface SimulationDataService {
	...
	void createData(int projectId, String name, String description, VCSType vcsType, String repositoryUrl, String pomDirectory, String mavenGoals, String startupFile);
	void editData(int dataId, String name, String description, VCSType vcsType, String repositoryUrl, String pomDirectory, String mavenGoals, String startupFile);
}